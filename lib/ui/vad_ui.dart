...
class _VadUIState extends State<VadUI> {
  ...
  Future<void> pickAudioFile() async {
    ...
    uploadInput.onChange.listen((e) async {
      ...
      reader.onLoadEnd.listen((e) async {
        ...
        await processFile(filePath, audioData);
      });
  ...
  Future<void> processFile(String filePath, Uint8List audioData) async {
    ...
    // Yozuvni yaratish
    final startRecording = Recording(
      type: RecordingType.speechStart,
      timestamp: startTime,
    );

    final endRecording = Recording(
      type: RecordingType.speechEnd,
      timestamp: endTime,
    );

    setState(() {
      recordings.add(startRecording);
      recordings.add(endRecording);
    });
  }
...
// ... VadUI ichida build() metodida:
                ...
                ElevatedButton(
                  onPressed: pickAudioFile, // Fayl tanlash
